...
Gem::Specification.new do |spec|
  spec.name = 'mail_smtp_connection_pool'
  spec.version = '0.1.0'
  ...
  spec.homepage = 'https://github.com/FabioTranjan/mail_smtp_connection_pool'
  spec.metadata = { 'source_code_uri' => 'https://github.com/FabioTranjan/mail_smtp_connection_pool' }
  spec.license = 'MIT'
